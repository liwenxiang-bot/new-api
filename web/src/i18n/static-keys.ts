...
export const STATIC_I18N_KEYS = [
  ...
  // Custom homepage (content data passed to t at runtime)
  'AI Productivity Infrastructure for Enterprises',
  'A Unified Gateway for AI Models',
  'Connect to Global AI Capabilities',
  ...
  'Connect by Replacing the Base URL',
  'Get API Key',
  ...
  'Multi-Region Nodes',
  'Real-Time Routing',
  'Switch dynamically based on health and latency weights to ensure the best response.',
  'Unified Monitoring',
  'Visualize calls, costs, and errors in one place to keep track of operational status.',
  'Smart Rate Limiting',
  'Use multidimensional policies to prioritize core workloads and avoid traffic spikes.',
  'Core Values',
  ...
  'One Entry Point, Fast Connections',
  'Connect all AI model providers with a single domain and API key, with intelligent failover to keep your business running.',
  'Full-Stack Observability and Risk Control',
  'Monitor calls, error rates, and costs in real time, and configure rate limits, alerts, and security policies in one click.',
  'On-Demand Scaling and Cost Optimization',
  'Control costs and concurrency with multi-channel quotas, intelligent routing, and batch task scheduling.',
  'A Developer-Friendly Experience',
  'Compatible with the OpenAI API protocol, with SDKs, examples, and a Web Playground for easy iteration and deployment.',
  'Workflow',
  'Build Your AI Control Plane in 3 Steps',
  'Integration Setup',
  'Create channels, set API keys and limits, and import model lists in the console.',
  'Smart Routing',
  'Automatically choose the best model channel based on health, latency, and price, with built-in failover.',
  'Continuous Insights',
  'Track call trends, usage, and failure rates through the dashboard, with real-time alerts to ensure SLOs.',
  'Ecosystem Partners',
  'Deep Integration with Leading Model Providers',
  ...
  'Qingyan',
  'Xinference',
  'Bring AI Model Capabilities into Your Business Workflows',
