      ...
      >
        <div className='mx-auto w-full max-w-6xl px-6 py-5'>
          <div className='bg-muted/20 border-border/50 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 rounded-2xl border px-4 py-4 backdrop-blur-sm sm:px-5'>
            ...
            />
            <div className='text-muted-foreground/45 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs empty:hidden'>
              <LegalLinks />
            </div>
          </div>
        </div>
  ...
  return (
    ...
    >
      <div className='mx-auto max-w-6xl px-6 py-12 md:py-16'>
        ...
        {/* Project attribution is displayed on the About page. */}
        <div className='border-border/30 mt-12 border-t pt-6'>
          <div className='text-muted-foreground/40 flex flex-wrap items-center justify-start gap-x-2 gap-y-1 text-xs'>
            <span>
